...
%% Generate multiple rossler signalsData with constant noise

a2 = 0.2; 
b2 = 0.3; 
c2 = 10; 
overall_noise = 0.3*randn;
overall_noise = repmat(overall_noise,[1 3]); 
...
for i = 1:num_conditions2
    ...
    [t, y] = ode45(@(t, y) rossler_system(t, y, a2, b2, c2, overall_noise), tspan, init_cond);
    ...
    signalsData{i, 6} = overall_noise(1); % Noise strength
end
